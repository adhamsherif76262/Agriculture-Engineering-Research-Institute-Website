  ...
  <div id = "Upper_Footer_Left">
      ...
      <div id = "Footer_ContactInfo">
          ...
          <div class = "Single_Contact_Info Single_Contact_Info_Ar">
              <img width = "40px" src = ".${IMAGESpath}/Images/noun-address-2048877.png" alt = "Email Address Icon">
              <span> شارع نادى الصيد - الدقى - الجيزة - ص ب ٢٥٦</span>
              <span>: العنوان</span>
          </div>
          <div class = "Single_Contact_Info Single_Contact_Info_Ar">
              <img width = "40px" src = ".${IMAGESpath}/Images/noun-phone-2632790.png" alt = "Email Address Icon">
              <span id = "Land_Line_Span_Ar"> ٣٧٤٨٧٢۱۲ - ٣٣٣٧٥٨٥٣ </span>
              <span> : التليفون أرضي</span>
          </div>
          <div class = "Single_Contact_Info Single_Contact_Info_Ar">
              <img width = "40px" src = ".${IMAGESpath}/Images/noun-email-6924545.png" alt = "Email Address Icon">
...
var En_FooterTemplate = `
  ...
  <div>
    ...
    <a class="ARC_Logo image" href=".${IMAGESpath}/Home.html" ><img class="NavBar_Logos" src=".${IMAGESpath}/Images/AERI-ARC-Logo_-removebg .png" alt="Agriculture Engineering Institute Logo"></a>
  </div>
  <div>
    <div><b>Eldew</b><a href="#">Secuce</a><a href="#">Drupand</a><a href="#">Oceash</a><a href="#">Ugefe</a><a href="#">Babed</a></div>
    <div><b>Spotha</b><a href="#">Miskasa</a><a href="#">Agithe</a><a href="#">Scesha</a><a href="#">Lulle</a></div>
    ...
    <div><b>Athod</b><a href="#">Pamuz</a><a href="#">Vapert</a><a href="#">Neesk</a><a href="#">Omemanen</a></div>
      ...
      <div id = "Lower_Footer">
      <p>©2024 Agriculture Engineering Research Institute</p>
      <div id = "Footer_Btns_Div">
        ${TopBtnEn}
        ${Footer_LangBtnAr}
      </div>
